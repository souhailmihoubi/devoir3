...
import com.souhail.produits.entities.Categorie;
...
class Produits1ApplicationTests {
	...
	{
	List<Produit> prods = produitRepository.findByNomProduitContains("C");
	for (Produit p : prods) {
		System.out.println(p);
	}
	}
	...
	public void testfindByNomPrix(){
		...
		List<Produit> prods = produitRepository.findByNomPrix("Casque Cooler Master", 160.0);
		for (Produit p : prods){
			System.out.println(p);
		}
	}
